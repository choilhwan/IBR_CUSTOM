CLASS zbp_mm_r_product_cjwms DEFINITION PUBLIC ABSTRACT FINAL FOR BEHAVIOR OF zmm_r_product_cjwms.
PUBLIC SECTION.
    TYPES:
      ty_r_product TYPE RANGE OF matnr,
      BEGIN OF ty_s_product_result,
        product                TYPE zmm_r_product_cjwms-product,
        baseunit               TYPE zmm_r_product_cjwms-baseunit,
...
*        yy1_transferdate_plt   TYPE i_productplantbasic-yy1_transferdate_plt,
  ...
  CLASS-DATA:
      GT_product_plant TYPE ty_t_product_result.
ENDCLASS.

CLASS zbp_mm_r_product_cjwms IMPLEMENTATION.
ENDCLASS.
