interface ZIF_PRODUCT_CREATED_V1
  public .
  ...
  types:
    TY_S_PRODUCT_CREATED_V1 TYPE STRUCTURE FOR HIERARCHY Z_Product_Created_v1 .

  methods GET_BUSINESS_DATA
    returning
      value(RS_BUSINESS_DATA) type ty_s_product_created_v1
    raising
      /IWXBE/CX_EXCEPTION .
endinterface.
